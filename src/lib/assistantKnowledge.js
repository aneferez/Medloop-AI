export const PRIMARY_ASSISTANT_LANGUAGE = 'en'

export const assistantLanguages = [
  { id: 'en', label: 'English · Primary voice', speechCode: 'en-IN', primary: true },
...
const localizedCopy = {
  en: {
    guide: 'MedLoop AI guide', welcome: 'Welcome', inSection: 'you’re in', listen: 'Listen', stop: 'Stop', searchPlaceholder: 'Ask about medicines, reminders, privacy…', ask: 'Ask', noAnswer: 'I can only answer approved MedLoop help topics. Try asking about medicines, reminders, backups, family alerts, appointments, reports, privacy, or emergencies.', unsafe: 'I can’t diagnose conditions, change doses, or provide prescription advice. Follow the original prescription and contact a pharmacist or clinician for medical questions.', helpful: 'Was this helpful?', thanks: 'Thanks — your anonymous response was saved only on this device.', yes: 'Yes', no: 'No', approved: 'Approved MedLoop help only. Questions stay within the medication workflow.', safety: 'Medication guidance only — educational information, not diagnosis, dosage advice, prescription advice, or emergency monitoring.', searchTitle: 'Search help', automatic: 'Automatically introduce sections I haven’t visited', next: 'Next section', recommended: 'Recommended next', progress: 'sections introduced', voiceUnavailable: 'Voice guidance is unavailable on this device.', emergency: 'For an emergency, call local emergency services now.',
  },
  hi: {
    guide: 'MedLoop AI मार्गदर्शक', welcome: 'स्वागत है', inSection: 'आप इस भाग में हैं:', listen: 'सुनें', stop: 'रोकें', searchPlaceholder: 'दवा, रिमाइंडर या गोपनीयता के बारे में पूछें…', ask: 'पूछें', noAnswer: 'मैं केवल स्वीकृत MedLoop सहायता विषयों का उत्तर दे सकता हूँ। दवा, रिमाइंडर, बैकअप, परिवार अलर्ट, अपॉइंटमेंट, रिपोर्ट, गोपनीयता या आपातकाल के बारे में पूछें।', unsafe: 'मैं बीमारी का निदान, खुराक बदलने या प्रिस्क्रिप्शन की सलाह नहीं दे सकता। मूल प्रिस्क्रिप्शन का पालन करें और चिकित्सा प्रश्नों के लिए डॉक्टर या फार्मासिस्ट से संपर्क करें।', helpful: 'क्या यह उपयोगी था?', thanks: 'धन्यवाद — आपकी गुमनाम प्रतिक्रिया केवल इस डिवाइस पर सहेजी गई।', yes: 'हाँ', no: 'नहीं', approved: 'केवल स्वीकृत MedLoop सहायता। सवाल दवा-प्रबंधन कार्यप्रवाह तक सीमित हैं।', safety: 'केवल दवा मार्गदर्शन — शैक्षिक जानकारी, निदान या खुराक की सलाह नहीं।', searchTitle: 'सहायता खोजें', automatic: 'नए भागों का परिचय अपने-आप दिखाएँ', next: 'अगला भाग', recommended: 'अगला सुझाव', progress: 'भागों का परिचय पूरा', voiceUnavailable: 'इस डिवाइस पर आवाज़ मार्गदर्शन उपलब्ध नहीं है।', emergency: 'आपातकाल में तुरंत स्थानीय आपातकालीन सेवा को कॉल करें।',
  },
  ta: {
    guide: 'MedLoop AI வழிகாட்டி', welcome: 'வரவேற்கிறோம்', inSection: 'நீங்கள் உள்ள பகுதி:', listen: 'கேட்க', stop: 'நிறுத்து', searchPlaceholder: 'மருந்து, நினைவூட்டல் அல்லது தனியுரிமை பற்றி கேளுங்கள்…', ask: 'கேள்', noAnswer: 'அங்கீகரிக்கப்பட்ட MedLoop உதவி தலைப்புகளுக்கு மட்டுமே பதிலளிக்க முடியும். மருந்துகள், நினைவூட்டல்கள், காப்புப்பிரதி, குடும்ப எச்சரிக்கைகள், சந்திப்புகள், அறிக்கைகள், தனியுரிமை அல்லது அவசரநிலை பற்றி கேளுங்கள்.', unsafe: 'நோயை கண்டறியவும், மருந்தளவை மாற்றவும், மருந்துச் சீட்டு ஆலோசனை வழங்கவும் என்னால் முடியாது. அசல் மருந்துச் சீட்டைப் பின்பற்றி மருத்துவ கேள்விகளுக்கு மருத்துவர் அல்லது மருந்தாளரை அணுகவும்.', helpful: 'இது பயனுள்ளதாக இருந்ததா?', thanks: 'நன்றி — உங்கள் பெயரில்லா பதில் இந்தச் சாதனத்தில் மட்டும் சேமிக்கப்பட்டது.', yes: 'ஆம்', no: 'இல்லை', approved: 'அங்கீகரிக்கப்பட்ட MedLoop உதவி மட்டும். கேள்விகள் மருந்து மேலாண்மை செயல்முறைக்குள் இருக்கும்.', safety: 'மருந்து வழிகாட்டல் மட்டும் — கல்வித் தகவல்; நோய் கண்டறிதல் அல்லது மருந்தளவு ஆலோசனை அல்ல.', searchTitle: 'உதவி தேடல்', automatic: 'பார்க்காத பகுதிகளை தானாக அறிமுகப்படுத்து', next: 'அடுத்த பகுதி', recommended: 'அடுத்த பரிந்துரை', progress: 'பகுதிகள் அறிமுகப்படுத்தப்பட்டன', voiceUnavailable: 'இந்தச் சாதனத்தில் குரல் வழிகாட்டல் கிடைக்கவில்லை.', emergency: 'அவசரநிலையில் உடனே உள்ளூர் அவசர சேவையை அழைக்கவும்.',
  },
}
...
const sectionTranslations = {
  hi: {
    ...
    prescriptions: ['प्रिस्क्रिप्शन', 'प्रिस्क्रिप्शन रिकॉर्ड साथ रखें', 'डॉक्टर, क्लिनिक, लिखित नोट और प्रिस्क्रिप्शन फोटो को सही संदर्भ के लिए सुरक्षित रखें।'],
    ...
    legal: ['गोपनीयता और सुरक्षा', 'MedLoop की सीमाएँ समझें', 'डिवाइस और cloud डेटा, रिमाइंडर की सीमाएँ, चिकित्सा अस्वीकरण और अकाउंट हटाने की जानकारी पढ़ें।'],
  },
  ta: {
    ...
    prescriptions: ['மருந்துச் சீட்டுகள்', 'மருந்துச் சீட்டு பதிவுகளை ஒன்றாக வைத்திருங்கள்', 'மருத்துவர், மருத்துவமனை, எழுதப்பட்ட குறிப்பு மற்றும் மருந்துச் சீட்டு படத்தை சரியான குறிப்புக்காக சேமிக்கவும்.'],
    ...
    legal: ['தனியுரிமை மற்றும் பாதுகாப்பு', 'MedLoop என்ன செய்ய முடியும் என்பதை அறியுங்கள்', 'சாதன மற்றும் cloud தரவு, நினைவூட்டல் வரம்புகள், மருத்துவ மறுப்பு மற்றும் கணக்கு நீக்கல் தகவலைப் படிக்கவும்.'],
  },
}
...
const knowledgeBase = {
  en: [
    ...
    { keywords: ['privacy', 'private', 'data', 'cloud'], answer: 'Health records may sync to MedLoop cloud services when cloud mode is enabled. This approved help search stays on this device and does not send questions to a hosted AI service.' },
  ...
  hi: [
    ...
    { keywords: ['गोपनीयता', 'डेटा', 'क्लाउड', 'privacy'], answer: 'Cloud mode चालू होने पर स्वास्थ्य रिकॉर्ड MedLoop cloud services से sync हो सकते हैं। यह approved help search इस डिवाइस पर रहता है और सवाल hosted AI service को नहीं भेजता।' },
  ...
  ta: [
    ...
    { keywords: ['தனியுரிமை', 'தரவு', 'கிளவுட்', 'privacy'], answer: 'Cloud mode இயக்கப்பட்டால் சுகாதாரப் பதிவுகள் MedLoop cloud சேவைகளுடன் ஒத்திசைக்கப்படலாம். இந்த approved help search சாதனத்திலேயே இருக்கும்; கேள்விகள் hosted AI சேவைக்கு அனுப்பப்படாது.' },
...
export function getAssistantCopy(language = PRIMARY_ASSISTANT_LANGUAGE) {
  return localizedCopy[language] || localizedCopy[PRIMARY_ASSISTANT_LANGUAGE]
}

export function localizeSectionGuide(pageId, guide, language = PRIMARY_ASSISTANT_LANGUAGE) {
...
export function localizeRecommendation(recommendation, language = PRIMARY_ASSISTANT_LANGUAGE) {
...
export function searchApprovedHelp(query, language = PRIMARY_ASSISTANT_LANGUAGE) {
  const normalized = String(query || '').trim().toLocaleLowerCase()
  if (!normalized) return null
  const entries = knowledgeBase[language] || knowledgeBase[PRIMARY_ASSISTANT_LANGUAGE]
